...
class CudaMatrixFreeOperator final : public Operator<VectorType>
{
public:
  ...
  virtual std::shared_ptr<Operator<vector_type>> transpose() const override;

  virtual std::shared_ptr<Operator<vector_type>>
  multiply(std::shared_ptr<Operator<vector_type> const> b) const override;

  virtual std::shared_ptr<Operator<vector_type>> multiply_transpose(
      std::shared_ptr<Operator<vector_type> const> b) const override;

  virtual std::shared_ptr<vector_type> build_domain_vector() const override;

  virtual std::shared_ptr<vector_type> build_range_vector() const override;

  virtual size_t grid_complexity() const override;

  virtual size_t operator_complexity() const override;
